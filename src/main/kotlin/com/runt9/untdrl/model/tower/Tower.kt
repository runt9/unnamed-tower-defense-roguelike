...
class Tower(val definition: TowerDefinition, val texture: Texture) : BaseSteerable(Vector2.Zero, 0f) {
    ...
    var level = 1
    var maxCores = 1
    var specializationPoints = 0
    var selectableSpecializationOptions = 2
    ...
    val availableSpecializations = mutableListOf<TowerSpecializationDefinition>()
    val selectableSpecializations = mutableListOf<TowerSpecializationDefinition>()
    val appliedSpecializations = mutableListOf<TowerSpecializationDefinition>()
