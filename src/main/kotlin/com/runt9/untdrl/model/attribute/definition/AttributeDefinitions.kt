...
val critChance = attribute("Crit", "Crit Chance", PERCENT, 20f..50f) { displayPercent() }
...
val buffEffect = attribute("BDE", "Buff/Debuff Effect", PERCENT, 10f..20f) { displayPercent() }
